...
$cus_full_name= "$first_name".' '."$last_name";
...
try {
    ...
    $mail->addAddress($email, $cus_full_name);
...
$sql6 = "SELECT * FROM tbl_products p, tbl_cart c WHERE p.product_id=c.cart_id";
...
$new_quantity=$product_quantity-$cartQty;


$sql7 = "UPDATE tbl_products SET product_quantity=$new_quantity WHERE product_id=$product_id";
